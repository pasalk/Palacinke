...
HA_URL = 'http://192.168.184.133:8123/api/webhook/device_3_humidity_data'
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                print("3 Data sent successfully")
...
def http_server():
    ...
    s.bind(('', 82))
    s.listen(5)
    print(Fore.YELLOW + "HTTP Server is running on port 82..." + Style.RESET_ALL)
