...
HA_URL = 'http://192.168.184.133:8123/api/webhook/device_4_humidity_data'
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                print("4 Data sent successfully")
...
def http_server():
    ...
    s.bind(('', 83))
    s.listen(5)
    print(Fore.YELLOW + "HTTP Server is running on port 83..." + Style.RESET_ALL)
